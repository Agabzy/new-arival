...
if($_SERVER['REQUEST_METHOD']=== 'POST'){
  ...
  $sql = "INSERT INTO message(fname,lname,email,msg) VALUES ('$fname','$lname','$email','$message')";
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
     <span class="brand-text font-weight-medium">New Arrival Gsm World</span>
    </a>
    ...
    <section class="content">
      ...
      <div class="card">
              ...
              <div class="card-body table-responsive p-0" style="height: 150px;">
                <table class="table table-bordered table-hover table-striped table-head-fixed text-nowrap">
                  <thead>
                    <tr>
                      <th>#</th>
                      <th>Firstname</th>
                  ...
                  <?php
                   ...
                   $msg = mysqli_fetch_all($query, MYSQLI_ASSOC);
                   $i=1;  
                    foreach($msg as $item) : ?>
                   <tr>
                    <td><?php echo $i ?></td>
                    ...
                    <td>
                    <a class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this record?')" href="">DELETE </a> 
                    </td>
                   </tr>
                   <?php $i++; endforeach; ?>
